...
public class EMP extends Weapon2D {

	public EMP(AbstractWorldEngine world_engine, Uid uid, String name, Object2D owner, float cooldown) {
	...
	protected Joint getJoint(Object2D owner) {
		WeldJoint weld_joint = new WeldJoint(owner.getBody(), getBody(), new Vector2());
